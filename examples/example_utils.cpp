...
#else  // MIP_ENABLE_TCP
        throw std::runtime_error("This program was compiled without socket support. Recompile with -DMIP_ENABLE_TCP=1");
#endif // MIP_ENABLE_TCP
...
#else  // MIP_ENABLE_SERIAL
        throw std::runtime_error("This program was compiled without serial support. Recompile with -DMIP_ENABLE_SERIAL=1.\n");
#endif //MIP_ENABLE_SERIAL
    }
